...
import { cloudflareImageLoader } from '../utils/cloudflare'
const HeaderLayout = () => {
  ...
  return (<header className="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-pink-600">
    <div className="flex items-center">
      <Link href="#">
        <a aria-label="Open Menu" onClick={activeSidebar} className="text-gray-500 focus:outline-none lg:hidden">
    ...
    <div className="flex items-center">
      <Link href="#">
        <a aria-label="Notification" className="flex mx-4 text-gray-600 focus:outline-none"><svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 17H20L18.5951 15.5951C18.2141 15.2141 18 14.6973 18 14.1585V11C18 8.38757 16.3304 6.16509 14 5.34142V5C14 3.89543 13.1046 3 12 3C10.8954 3 10 3.89543 10 5V5.34142C7.66962 6.16509 6 8.38757 6 11V14.1585C6 14.6973 5.78595 15.2141 5.40493 15.5951L4 17H9M15 17V18C15 19.6569 13.6569 21 12 21C10.3431 21 9 19.6569 9 18V17M15 17H9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
        </a>
      </Link>
      <div className="relative">
        <Link href="#">
          <a onClick={toggle} className="relative z-10 block h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none">
            <Image
        ...
        <div className={"absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20" + (!menuActive ? " hidden" : "")}>
          <Link href="#">
            <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Profile</a>
          </Link>
          <Link href="#">
            <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Products</a>
          </Link>
          <Link href="/">
            <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Log out</a>
          </Link>
        </div>
      </div>
    </div>
